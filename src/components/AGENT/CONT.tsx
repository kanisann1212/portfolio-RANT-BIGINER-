...
export const CONT = ({A}:AProps) =>{
  ...
  return(
    <>
      <div className="relative bg-[url(/OMEN.jpg)] bg-size-[auto_px] mask-b-from-80% bg-no-repeat mask-t-from-90%"
      >
        <h1 className="text-black text-8xl absolute left-190 top-50">CONTROLLER</h1>
