...
export const MarshalLayout = ({ Guninfo }: Props) => {
  const Gaia1 = Guninfo.skins.filter((skin: string[], index: number) => index === 30)
  const Gaia2 = Gaia1[0].chromas[1]
console.log(Guninfo.weaponStats.reloadTimeSeconds)
  return (
    <>
